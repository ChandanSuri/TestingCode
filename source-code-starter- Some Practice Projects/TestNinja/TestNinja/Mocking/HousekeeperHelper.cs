...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        // We make this function public and then take it to another class as it uses and external resource but we should not work on private methods.
        */
    ...
    {
        public void Show(string s, string housekeeperStatements, MessageBoxButtons ok) // static removed
        {
        }
    }
